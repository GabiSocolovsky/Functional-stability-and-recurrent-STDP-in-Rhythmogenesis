...
Jeidotall=1000*(Jeidot(:)); % Strecthing the SIZE of arrows (multiply every component by 1000 - see line below as well), and saving them as vectors! 
Jiedotall=1000*(Jiedot(:));
Jieall=round(Jie_grid',7);
Jeiall=round(Jei_grid',7);
Jeiall=Jeiall(:); % a vector of Jei values
Jieall=Jieall(:); % a vector of Jie values
